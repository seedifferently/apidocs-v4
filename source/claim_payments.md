...
| control_number             | {string}                                                         | Control number assigned byt he payer to the claim payment.                                                                                          | Yes       |
...
| patient_control_number     | {string}                                                         | Patient control number reference for the claim payment.  This value will always be PokitDok's encoded Activity ID and can be used to ping the Activities API to retreive original claim submission information.                                                                                | Yes       |
