...
| coverage.limitations.quantity                       | The quantity of services being requested. |
| coverage.limitations.quantity_qualifier             | The qualifier used to indicate the quantity type. A full list of possible values is included [below](#quantity-qualifier). |   
