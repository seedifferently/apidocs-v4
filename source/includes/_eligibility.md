...
| coverage.coinsurance.plan_begin_date                | Coinsurance plan begin date for the member specified in the eligibility request. In ISO8601 format (YYYY-MM-DD). |
| coverage.coinsurance.plan_end_date                  | Coinsurance plan end date for the member specified in the eligibility request. In ISO8601 format (YYYY-MM-DD). |
