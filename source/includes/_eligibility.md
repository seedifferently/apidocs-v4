...
| coverage.primary_care_provider.messages.message     | Messages associated with the coverages benefit's plan.                                                                                                                                                                                                                                                                                                                                                                                                                                |                                                                                        | coverage.plans                                      | A complete list of plans that are included in the member's coverage.                                                                                                                                                                                                                                                                                                                                                                                                          |
