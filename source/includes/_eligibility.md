...
| coverage.non_covered.quantity                       | The quantity of services being requested. |
| coverage.non_covered.quantity_qualifier             | The qualifier used to indicate the quantity type. (e.g. visits, month, hours, units, days) |   
...
| coverage.quantity                                   | The quantity of services being requested. |
| coverage.quantity_qualifier                         | The qualifier used to indicate the quantity type. (e.g. visits, month, hours, units, days) |   
