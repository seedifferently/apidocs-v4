...
| coverage.limitations.time_period_qualifier         | The time period for which limitiations apply.                                                                                                                                                                                                                                                                                                             |
...
| coverage.limitations.quantity                       | The quantity amount specified by quantity_qualifier. |
