...
>Example fetching trading partner response (for a more complete response please use the test application):
...
> Example fetching information for a specific trading partner response:
